...
def isCyrillic(text): # возвращает True, если введенное слово содержит кириллические символы, и False, если буквы – латинские.
	return bool(re.search('[а-яА-Я]', text))

text = input('Введите слово для подсчёта очков: ').upper() #чтобы все были заглавные
...
#решение взято с просторов интернета. я его поняла, но сама бы не додумалась